              ...
              <div  className="sidebar-widget-body">
                <div  className="accordion">
                  <div  className="accordion-group">
                    ...
                    {/* <!-- /.accordion-heading --> */}
                    <div  className="accordion-body collapse" id="collapseOne"  >
                  ...
                  <div  className="accordion-group">
                    ...
                    {/* <!-- /.accordion-heading --> */}
                    <div  className="accordion-body collapse" id="collapseTwo"  >
                      <div  className="accordion-inner">
                        <ul>
                          <li><a href="#">gaming</a></li>
                          <li><a href="#">office</a></li>
                  ...
                  <div  className="accordion-group">
                    ...
                    {/* <!-- /.accordion-heading --> */}
                    <div  className="accordion-body collapse" id="collapseThree"  >
                      <div  className="accordion-inner">
                        <ul>
                          <li><a href="#">gaming</a></li>
                          <li><a href="#">office</a></li>
                  ...
                  <div  className="accordion-group">
                    ...
                    {/* <!-- /.accordion-heading --> */}
                    <div  className="accordion-body collapse" id="collapseFour"  >
                      <div  className="accordion-inner">
                        <ul>
                          <li><a href="#">gaming</a></li>
                          <li><a href="#">office</a></li>
                  ...
                  <div  className="accordion-group">
                    ...
                    {/* <!-- /.accordion-heading --> */}
                    <div  className="accordion-body collapse" id="collapseFive"  >
                      <div  className="accordion-inner">
                        <ul>
                          <li><a href="#">gaming</a></li>
                          <li><a href="#">office</a></li>
                  ...
                  <div  className="accordion-group">
                    ...
                    {/* <!-- /.accordion-heading --> */}
                    <div  className="accordion-body collapse" id="collapseSix"  >
                      <div  className="accordion-inner">
                        <ul>
                          <li><a href="#">gaming</a></li>
                          <li><a href="#">office</a></li>
                  ...
                  <div  className="products">
                    <div  className="product-list product">
                      <div  className="row product-list-row">
                        <div  className="col col-sm-4 col-lg-4">
                          <div  className="product-image">
                            <div  className="image"> <img src="assets/images/products/p4.jpg" alt=""/> </div>
                          </div>
                          {/* <!-- /.product-image -->  */}
                        </div>
                        {/* <!-- /.col --> */}
                  ...
                  <div  className="products">
                    <div  className="product-list product">
                      <div  className="row product-list-row">
                        <div  className="col col-sm-4 col-lg-4">
                          <div  className="product-image">
                            <div  className="image"> <img src="assets/images/products/p5.jpg" alt=""/> </div>
                          </div>
                          {/* <!-- /.product-image -->  */}
                        </div>
                        {/* <!-- /.col --> */}
                  ...
                  <div  className="products">
                    <div  className="product-list product">
                      <div  className="row product-list-row">
                        <div  className="col col-sm-4 col-lg-4">
                          <div  className="product-image">
                            <div  className="image"> <img src="assets/images/products/p6.jpg" alt=""/> </div>
                          </div>
                          {/* <!-- /.product-image -->  */}
                        </div>
                        {/* <!-- /.col --> */}
                  ...
                  <div  className="products">
                    <div  className="product-list product">
                      <div  className="row product-list-row">
                        <div  className="col col-sm-4 col-lg-4">
                          <div  className="product-image">
                            <div  className="image"> <img src="assets/images/products/p7.jpg" alt=""/> </div>
                          </div>
                          {/* <!-- /.product-image -->  */}
                        </div>
                        {/* <!-- /.col --> */}
                  ...
                  <div  className="products">
                    <div  className="product-list product">
                      <div  className="row product-list-row">
                        <div  className="col col-sm-4 col-lg-4">
                          <div  className="product-image">
                            <div  className="image"> <img src="assets/images/products/p8.jpg" alt=""/> </div>
                          </div>
                          {/* <!-- /.product-image -->  */}
                        </div>
                        {/* <!-- /.col --> */}
                  ...
                  <div  className="products">
                    <div  className="product-list product">
                      <div  className="row product-list-row">
                        <div  className="col col-sm-4 col-lg-4">
                          <div  className="product-image">
                            <div  className="image"> <img src="assets/images/products/p9.jpg" alt=""/> </div>
                          </div>
                          {/* <!-- /.product-image -->  */}
                        </div>
                        {/* <!-- /.col --> */}
                  ...
                  <div  className="products">
                    <div  className="product-list product">
                      <div  className="row product-list-row">
                        <div  className="col col-sm-4 col-lg-4">
                          <div  className="product-image">
                            <div  className="image"> <img src="assets/images/products/p10.jpg" alt=""/> </div>
                          </div>
                          {/* <!-- /.product-image -->  */}
                        </div>
                        {/* <!-- /.col --> */}
                  ...
                  <div  className="products">
                    <div  className="product-list product">
                      <div  className="row product-list-row">
                        <div  className="col col-sm-4 col-lg-4">
                          <div  className="product-image">
                            <div  className="image"> <img src="assets/images/products/p11.jpg" alt=""/> </div>
                          </div>
                          {/* <!-- /.product-image -->  */}
                        </div>
                        {/* <!-- /.col --> */}
                  ...
                  <div  className="products">
                    <div  className="product-list product">
                      <div  className="row product-list-row">
                        <div  className="col col-sm-4 col-lg-4">
                          <div  className="product-image">
                            <div  className="image"> <img src="assets/images/products/p12.jpg" alt=""/> </div>
                          </div>
                          {/* <!-- /.product-image -->  */}
                        </div>
                        {/* <!-- /.col --> */}
                  ...
                  <div  className="products">
                    <div  className="product-list product">
                      <div  className="row product-list-row">
                        <div  className="col col-sm-4 col-lg-4">
                          <div  className="product-image">
                            <div  className="image"> <img src="assets/images/products/p13.jpg" alt=""/> </div>
                          </div>
                          {/* <!-- /.product-image -->  */}
                        </div>
                        {/* <!-- /.col --> */}
                  ...
                  <div  className="products">
                    <div  className="product-list product">
                      <div  className="row product-list-row">
                        <div  className="col col-sm-4 col-lg-4">
                          <div  className="product-image">
                            <div  className="image"> <img src="assets/images/products/p14.jpg" alt=""/> </div>
                          </div>
                          {/* <!-- /.product-image -->  */}
                        </div>
                        {/* <!-- /.col --> */}
